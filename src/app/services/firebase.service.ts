// Lightweight Firebase initializer and helper for Realtime Database/Auth
...
function ensureDatabaseUrl() {
    if (!firebaseConfig.databaseURL) {
        ...
        throw new Error(
            `Missing Realtime Database URL in environment file. Please add a databaseURL property in src/environments/environment.ts, for example:\n` +
